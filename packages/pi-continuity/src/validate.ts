...
export const boundedArray = (value: unknown, max: number, item: (entry: any) => boolean): boolean =>
...
export const stringList = (value: unknown, maxItems: number, maxLength: number): boolean =>
...
export const optional = <T>(value: unknown, check: (entry: any) => boolean): value is T | undefined =>
