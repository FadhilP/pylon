...
const TRANSIENT_PROVIDER_FAILURE = /\b429\b|rate.?limit|capacity|overload|temporar(?:y|ily)|service unavailable|server (?:error|busy)|\b50[0234]\b|ECONNRESET|ECONNREFUSED|EAI_AGAIN|ENETUNREACH|socket (?:closed|hang up)|connection (?:closed|reset)|fetch failed|websocket.?error|you can retry your request|try your request again|please retry your request/i;
