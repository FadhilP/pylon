...
After the first completed turn, unnamed sessions receive a concise display name from their first prompt. Existing names and manually cleared names remain untouched.
