  ...
  const listed = manager.listSkills(
    {
      skills: [
        {
          ...
          filePath,
          baseDir: skillDir,
          sourceInfo: { path: filePath, source: root, scope: "user", origin: "package", baseDir: agentDir },
      ...
      diagnostics: [
        { type: "warning", message: `Unable to read ${unreadablePath}`, path: unreadablePath },
        {
          ...
          path: unreadablePath,
          collision: { resourceType: "skill", name: "manual-review", winnerPath: filePath, loserPath: unreadablePath },
        },
      ],
    },
    3,
