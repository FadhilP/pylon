...
const extensionKinds: Record<string, FileIconKind> = {
  ...
  sql: "sql",
  svg: "svg",
  png: "image", jpg: "image", jpeg: "image", gif: "image", webp: "image", avif: "image", ico: "image", bmp: "image",
  pdf: "pdf",
  zip: "archive", gz: "archive", tgz: "archive", tar: "archive", bz2: "archive", xz: "archive", rar: "archive", "7z": "archive",
  yaml: "config", yml: "config", toml: "config", ini: "config", conf: "config", config: "config", env: "config", lock: "config",
  sh: "shell", bash: "shell", zsh: "shell", fish: "shell", ps1: "shell", bat: "shell", cmd: "shell",
  c: "code", cc: "code", cpp: "code", cxx: "code", h: "code", hpp: "code", cs: "code", java: "code", kt: "code", kts: "code", swift: "code", rb: "code", php: "code", vue: "code", svelte: "code",
  txt: "text", log: "text", csv: "text", xml: "text", rtf: "text",
};
