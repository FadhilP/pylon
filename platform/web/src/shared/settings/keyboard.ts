...
export const KEY_COMMANDS = [
  ...
  { id: "copy-entry", label: "Copy file or folder", group: "Explorer", scope: "explorer", binding: chord("C", "Mod") },
  { id: "cut-entry", label: "Cut file or folder", group: "Explorer", scope: "explorer", binding: chord("X", "Mod") },
  { id: "paste-entry", label: "Paste into folder", group: "Explorer", scope: "explorer", binding: chord("V", "Mod") },
  { id: "undo-move", label: "Undo explorer move", group: "Explorer", scope: "explorer", binding: chord("Z", "Mod") },
  { id: "redo-move", label: "Redo explorer move", group: "Explorer", scope: "explorer", binding: chord("Z", "Mod", "Shift") },
