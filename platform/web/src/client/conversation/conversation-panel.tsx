import { dispatchShortcut, isMacKeyboard, shortcutsBlocked } from "../ui/keyboard-shortcuts";
import { DEFAULT_KEYMAP, effectiveBinding, matchesBinding } from "../../shared/settings/keyboard";
import { AnnotationChips, useAnnotations } from "../workspace/annotations";
import {
  IconAlertTriangle,
  IconArrowBackUp,
  IconArrowUp,
...
import { pairAgentActivity } from "../sessions/agent-activity";
import { messageToolCallViews, pairedToolCallViews } from "./tool-call-model";
import { formatCompactNumber, formatWorkDuration } from "../ui/session-format";
import { parseFileReference } from "../workspace/file-reference";
...
import { agentColor, type AgentColorMap } from "../sessions/agent-color";
import { modelThinkingLevels, moveRailSelection, railThinkingAxis } from "./model-rail";
...
import { modelKey as toModelKey, useHiddenModels, visibleModels } from "../settings/model-visibility";
import { exitDelay } from "../ui/motion";
import { OverviewOrb } from "../ui/overview-primitives";
  ...
  return (
    <section className="conversation-panel" aria-label="Live conversation">
      ...
      <form
        ...
        onDragOver={event => {
          event.preventDefault();
          if (event.dataTransfer.types.includes(WORKSPACE_FILE_DRAG_TYPE)) event.dataTransfer.dropEffect = "copy";
        }}
        onDragLeave={event => {
